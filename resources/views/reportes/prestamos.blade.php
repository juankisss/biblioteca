    ...
    <table class="table table-bordered table-striped table-hover dataTable js-exportable_report---">
        <thead class="">
            <tr>
                <th width="3%">ID</th>
                <th>Fecha</th>
     ...
     <input type="hidden" id="tipoc" value="reservas">
