<div class="row">
    <div class="form-group col-sm-12">
        ...
        <select name="EJE_ID" class="js-example-basic-multiple EJE_ID SELECT2" required onChange="sel_con()">
    ...
    <div class="col-sm-12 pdetalle cardn" style="display:none">
...
<div class="row">
    ...
    <div class="col-sm-12 plector cardn" style="display:none">
...
<div class="row">
    <div class="form-group col-sm-6">
        <label>Fecha</label>
        <input type="text" name="RES_FECHAR" class="form-control RES_FECHAR fechar" required readonly value="{{date('Y-m-d')}}">
    </div>
    <div class="form-group col-sm-6">
        <label>Hora</label>
        <input type="text" name="RES_HORAR" class="form-control RES_HORAR hora" required readonly>
    </div>
    ...
    <div class="form-group col-sm-8 fpjornada">
        <label>Fecha</label>
        <input type="text" name="PRE_FECHA" class="form-control PRE_FECHA fech fechar" required readonly>
    </div>
    <div class="form-group col-sm-4 fpextenso" style="display:none">
        <label>Fecha</label>
        <input type="text" name="PRE_FECHA" class="form-control PRE_FECHA fechar fechd fecha1-" required readonly>
    </div>
    <div class="form-group col-sm-4 fpextenso" style="display:none">
        <label>Hasta</label>
        <input type="text" name="PRE_FECHAD" class="form-control PRE_FECHAD fechar fechad fechh fecha2-" required readonly>
    </div>-->
...
<div class="row">
    <div class="form-group col-sm-12">
        ...
        <textarea type="text" name="RES_OBS" class="form-control PRE_OBS"></textarea>
    </div>
</div>
