    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="largeModalLabel"><i class="zmdi zmdi-account-calendar"></i> Modificar Sección</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="{{ route('secciones.update',0) }}" enctype="multipart/form-data" class="form-edit">
                @csrf  
                {{ method_field('PUT') }}
                ...
                <div class="modal-footer">
                    <input type="hidden" name="id" class="SEC_ID">
